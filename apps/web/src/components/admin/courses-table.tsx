	...
	const columns: ColumnDef<Course>[] = [
		{
			...
			cell: ({ row }) => {
				...
				return (
					// biome-ignore lint/a11y/noStaticElementInteractions: this is how recommended in docs
					// biome-ignore lint/a11y/useKeyWithClickEvents: this is how recommended in docs
					<div
